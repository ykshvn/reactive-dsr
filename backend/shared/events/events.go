...
const (
	...
	EventRREQProcessed      EventType = "Rreq_processed"
	EventRREQDropped        EventType = "rreq_dropped"
	EventRREPForwarded      EventType = "rrep_forwarded"
	EventRouteDiscovered    EventType = "route_discovered"
	EventRREPGenerated      EventType = "rrep_generated"
